...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="@if(is_null($categoryNews)) {{ route('categorynews.store') }} @else {{ url('admin/categorynews/'.$categoryNews->id) }} @endif" method="POST" enctype="multipart/form-data">
                        @if (!is_null($categoryNews))
                            @method('PATCH')
                        @endif
                        @csrf
